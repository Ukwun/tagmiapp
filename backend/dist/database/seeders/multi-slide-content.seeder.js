...
exports.seedMultiSlideContent = seedMultiSlideContent;
...
async function seedMultiSlideContent(dataSource, users) {
    ...
    for (const user of users) {
        ...
        for (let postNum = 0; postNum < 20; postNum++) {
            ...
            const numSlides = postType === "text" ? 1 : Math.floor(Math.random() * 4) + 2;
            ...
            for (let slideNum = 0; slideNum < numSlides; slideNum++) {
                ...
                const content = contentRepository.create({
                    ...
                    backgroundColor,
                    duration,
                    backgroundMusicUrl: slideNum === 0 ? backgroundMusicUrl : null,
...
//# sourceMappingURL=multi-slide-content.seeder.js.map