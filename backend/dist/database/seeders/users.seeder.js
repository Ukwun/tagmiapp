...
async function seedUsers(dataSource) {
    ...
    const talentProfileRepository = dataSource.getRepository(talent_profile_entity_1.TalentProfile);
    const userMap = new Map();
    for (let i = 0; i < exports.SEEDED_USERS.length; i++) {
        const userData = exports.SEEDED_USERS[i];
