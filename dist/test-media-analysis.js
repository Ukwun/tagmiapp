...
async function main() {
    ...
    const allContent = videos.map(v => ({ ...v, _type: "video" }));
    ...
    for (let i = 0; i < allContent.length; i++) {
        ...
        try {
            ...
            const result = await mediaAnalysisService.analyzeContent(item._type, item.mediaUrl, item.caption);
...
//# sourceMappingURL=test-media-analysis.js.map