...
var ChatRoom = function () {
    var _classDecorators = [(0, typeorm_1.Entity)("chat_rooms")];
    ...
    var ChatRoom = _classThis = /** @class */ (function () {
        function ChatRoom_1() {
            ...
            this.createdAt = (__runInitializers(this, _bookingId_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
            this.updatedAt = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _updatedAt_initializers, void 0));
            this.participants = (__runInitializers(this, _updatedAt_extraInitializers), __runInitializers(this, _participants_initializers, void 0));
            this.messages = (__runInitializers(this, _participants_extraInitializers), __runInitializers(this, _messages_initializers, void 0));
    ...
    (function () {
        ...
        _type_decorators = [(0, typeorm_1.Column)({ type: "enum", enum: ["direct", "group", "booking"], default: "direct" })];
        _bookingId_decorators = [(0, typeorm_1.Column)("uuid", { nullable: true })];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)()];
        _updatedAt_decorators = [(0, typeorm_1.UpdateDateColumn)()];
        _participants_decorators = [(0, typeorm_1.ManyToMany)(function () { return user_entity_1.User; }), (0, typeorm_1.JoinTable)({
                name: "chat_room_participants",
                joinColumn: { name: "roomId", referencedColumnName: "id" },
                inverseJoinColumn: { name: "userId", referencedColumnName: "id" },
            })];
        _messages_decorators = [(0, typeorm_1.OneToMany)(function () { return chat_message_entity_1.ChatMessage; }, function (message) { return message.room; })];
