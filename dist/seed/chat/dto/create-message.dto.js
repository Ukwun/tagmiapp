...
var CreateMessageDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateMessageDto() {
                ...
                this.attachments = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _attachments_initializers, void 0));
        ...
        (function () {
            ...
            _content_decorators = [(0, swagger_1.ApiProperty)({ description: "Message content" }), (0, class_validator_1.IsString)()];
            _type_decorators = [(0, swagger_1.ApiProperty)({ description: "Message type", enum: ["text", "image", "file", "system"] }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(["text", "image", "file", "system"])];
            _attachments_decorators = [(0, swagger_1.ApiProperty)({ description: "File attachments", required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)(), (0, class_validator_1.IsString)({ each: true })];
