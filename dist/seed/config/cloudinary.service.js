...
var streamifier = __importStar(require("streamifier"));
var CloudinaryService = function () {
    ...
    var CloudinaryService = _classThis = /** @class */ (function () {
        ...
        CloudinaryService_1.prototype.uploadFile = function (file_1) {
            return __awaiter(this, arguments, void 0, function (file, folder) {
                if (folder === void 0) { folder = "hashtag"; }
        ...
        CloudinaryService_1.prototype.deleteFile = function (publicId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, cloudinary_1.v2.uploader.destroy(publicId)];
                });
            });
        };
        CloudinaryService_1.prototype.uploadVideo = function (file_1) {
            return __awaiter(this, arguments, void 0, function (file, folder) {
                if (folder === void 0) { folder = "hashtag/videos"; }
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            var uploadStream = cloudinary_1.v2.uploader.upload_stream({
                                folder: folder,
