...
var CreateCommentDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateCommentDto() {
                ...
                this.parentId = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _parentId_initializers, void 0));
        ...
        (function () {
            ...
            _text_decorators = [(0, swagger_1.ApiProperty)({ example: "Great work! Love the design." }), (0, class_validator_1.IsString)()];
            _parentId_decorators = [(0, swagger_1.ApiProperty)({ example: "uuid-of-parent-comment", required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsUUID)()];
