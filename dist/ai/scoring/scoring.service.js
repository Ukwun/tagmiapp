...
const engagement_signal_entity_1 = require("../../content/entities/engagement-signal.entity");
const redis_service_1 = require("../../config/redis.service");
let ScoringService = ScoringService_1 = class ScoringService {
    constructor(contentRepository, engagementSignalRepository, redisService) {
    ...
    async retryOnDeadlock(operation, maxRetries) {
        let lastError;
    ...
    async executeScoreRecalculation() {
        ...
        await this.contentRepository
            ...
            .set({
            engagementScore: () => `("likeCount" * 3) + ("commentCount" * 5) + ("shareCount" * 4) + ("viewCount" * 0.1) ` +
...
], ScoringService.prototype, "flushSignalQueue", null);
__decorate([
    (0, schedule_1.Cron)(schedule_1.CronExpression.EVERY_10_MINUTES),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ScoringService.prototype, "recalculateScores", null);
exports.ScoringService = ScoringService = ScoringService_1 = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(engagement_signal_entity_1.EngagementSignal)),
