...
function useParticipant(participant) {
  ...
  return {
    ...
    publications,
    subscribedTracks,
    cameraPublication: participant.getTrack(_livekitClient.Track.Source.Camera),
    microphonePublication: participant.getTrack(_livekitClient.Track.Source.Microphone),
    screenSharePublication: participant.getTrack(_livekitClient.Track.Source.ScreenShare),
    metadata
  };
}
